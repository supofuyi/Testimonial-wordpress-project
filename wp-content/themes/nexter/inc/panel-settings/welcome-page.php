...
$plugin_name = (!empty($whitelabel['nxt_free_plugin_name'])) ? $whitelabel['nxt_free_plugin_name'] : 'Nexter Theme';
	...
	echo '<div class="nxt-panel-row">';
		echo '<div class="nxt-br-4 nxt-panel-col nxt-panel-col-65" '.( !apply_filters('nexter_remove_branding',false) ? '' : 'style="flex-direction: column;"').'>';
			...
			echo '<div class="nxt-welcome-user-info nxt-p-15 nxt-mb-8">';
				...
				echo '</div>';
				echo '<div class="nxt-sec-subtitle nxt-mt-8">'.sprintf( __('Congratulations on installing %s. Get ready to explore the next generation of WordPress.','nexter'), $plugin_name ).'</div>';
				$nxt_pro_ext = '';
				if(defined('NXT_PRO_EXT')){
					...
					echo '<div class="nxt-free-pro-info-list">';
						...
						echo '<ul class="nxt-panel-list">';
							...
							if(!defined('NXT_PRO_EXT')){
								...
								echo '<li>'.esc_html__("Advanced Security",'nexter').'</li>';
								echo '<li>'.esc_html__("Advanced Performance",'nexter').'</li>';
								echo '<li>'.esc_html__("Branded WP Admin",'nexter').'</li>';
								echo '<li>'.esc_html__("Self-Host Google Fonts",'nexter').'</li>';
								echo '<li>'.esc_html__("Custom Fonts Upload",'nexter').'</li>';
			...
			echo '<div class="nxt-panel-row nxt-pro-info-new">';
						...
						echo '<ul class="nxt-product-info-list">';
                            ...
                            if(!defined("WDKIT_VERSION")){
                                if ( isset( $installed_plugins[ $wdk_plugin_file ] ) ) {
                                    $wdk_build_button = esc_html__('Activate Plugin','nexter');
                                    $wdk_plugin_process = esc_html__('Activating..','nexter');
                                    $wdk_plugin_status = 'nxt-active-builder-plugin';
                                }else{
                                    $wdk_build_button = esc_html__('Install Plugin','nexter');
                                    $wdk_plugin_process = esc_html__('Installing..','nexter');
                                    $wdk_plugin_status = 'nxt-install-builder-plugin';
                                }
                            }else if(defined("WDKIT_VERSION")){
                                $wdk_build_button = esc_html__('Activated','nexter');
                                $wdk_plugin_process = esc_html__('Activated','nexter');
				...
				echo '<div class="nxt-panel-col nxt-panel-col-50">';
					...
					echo '<div class="nxt-panel-sec nxt-welcome-whats-new nxt-p-20 nxt-mb-8">';
						...
						echo '<div class="nxt-sec-subtitle nxt-mb-8">'.sprintf( __('Check complete list of new changes done in %s','nexter'), $plugin_name).'</div>';
		...
		echo '<div class="nxt-panel-col nxt-panel-col-35">';
			...
			echo '<div class="nxt-panel-sec nxt-welcome-whats-new nxt-p-20 nxt-mb-8 nxt-mt-8">';
				...
				echo '<div class="nxt-sec-subtitle nxt-mb-8">'.sprintf( __('We hear you! Improve your %s with your amazing ideas.','nexter'), $plugin_name).'</div>';
